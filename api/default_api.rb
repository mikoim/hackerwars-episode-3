...
HomeQuest.add_route('DELETE', '/v1/child/{child_uuid}', 'resourcePath' => '/Default',
...
HomeQuest.add_route('GET', '/v1/child', 'resourcePath' => '/Default',
...
HomeQuest.add_route('POST', '/v1/child', 'resourcePath' => '/Default',
...
HomeQuest.add_route('GET', '/v1/notification', 'resourcePath' => '/Default',
...
HomeQuest.add_route('POST', '/v1/signin', 'resourcePath' => '/Default',
                                          'summary' => 'Login',
  ...
  begin
    if signin['login_token'] # for Child
      login_token = signin['login_token']
      child = search_child('login_token', login_token)

      raise HomeQuest::Error::InvalidCredential if child.nil?

      @homequest_tokens.store(homequest_token, child['uuid'])
    elsif signin['email'] && signin['password'] # for Parent
...
HomeQuest.add_route('POST', '/v1/signup', 'resourcePath' => '/Default',
...
HomeQuest.add_route('GET', '/v1/status', 'resourcePath' => '/Default',
                                         'summary' => 'Get Status',
                                         'nickname' => 'status_get',
...
HomeQuest.add_route('GET', '/v1/task', 'resourcePath' => '/Default',
...
HomeQuest.add_route('POST', '/v1/task', 'resourcePath' => '/Default',
                                        'summary' => 'Create Task',
                                        'nickname' => 'task_post',
                                        'responseClass' => 'Task',
                                        'endpoint' => '/task',
...
HomeQuest.add_route('DELETE', '/v1/task/{task_uuid}', 'resourcePath' => '/Default',
                                                      'summary' => 'Delete Task',
...
HomeQuest.add_route('GET', '/v1/task/{task_uuid}', 'resourcePath' => '/Default',
                                                   'summary' => 'Get Task',
...
HomeQuest.add_route('GET', '/v1/reward', 'resourcePath' => '/Default',
...
HomeQuest.add_route('POST', '/v1/reward', 'resourcePath' => '/Default',
...
HomeQuest.add_route('GET', '/v1/reward/{reward_uuid}', 'resourcePath' => '/Default',
                                                       'summary' => 'Earn Reward',
  ...
  # the guts live here
  user_uuid = @@homequest_tokens[request.env['HTTP_HOMEQUEST_TOKEN']]
  unless @user = search_for_child(settings.db[:parents].find, :uuid, user_uuid)
    status 500
    return message 'ユーザーは見つかりませんでした'
  end
  ...
  if @reward[:owner] == @user[:parent_uuid]
